...
MMPOSE_PATH = '/home/aita/uaitadisknew/wmhcode/PARE-master/mmpose-main/'
MMDET_PATH = '/home/aita/uaitadisknew/wmhcode/PARE-master/mmdetection-main/'

#MMPOSE_CFG = os.path.join(MMPOSE_PATH, 'configs/old_config/hrnet_w48_coco_wholebody_256x192.py')#这是旧版的位置，好像不能用
MMPOSE_CFG = os.path.join(MMPOSE_PATH, 'configs/wholebody_2d_keypoint/topdown_heatmap/coco-wholebody/td-hm_hrnet-w48_8xb32-210e_coco-wholebody-256x192.py')#新版位置改了
MMPOSE_CKPT = os.path.join(MMPOSE_PATH, 'checkpoints/hrnet_w48_coco_wholebody_256x192-643e18cb_20200922.pth')#自己下载configs/wholebody_2d_keypoint/topdown_heatmap/coco-wholebody/td-hm_hrnet-w48_8xb32-210e_coco-wholebody-256x192.py"

MMDET_CFG = os.path.join(MMDET_PATH, 'configs/faster_rcnn/faster_rcnn_r50_fpn_1x_coco.py')
MMDET_CKPT = os.path.join(MMDET_PATH, 'checkpoints/faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth')#自己下载


H36M_ROOT='/home/teacherDong02/wmh/datasets/Human3.6M/Images_all'
MPII_ROOT = '/home/teacherDong02/wmh/datasets/mpii'
LSPET_ROOT = '/home/teacherDong02/wmh/datasets/lspet'
COCO_ROOT ='/home/teacherDong02/wmh/datasets/coco'
MPI_INF_3DHP_ROOT ='/home/teacherDong02/wmh/datasets/mpi_inf_3dhp'
OH3D_ROOT = '/home/teacherDong02/wmh/datasets/3DOH50K'

PASCAL_ROOT='/home/teacherDong02/wmh/datasets/VOCdevkit/VOC2012'
PW3D_ROOT = '/home/teacherDong02/wmh/datasets/3DPW'
...
DATASET_FILES = [
    # Testing
    {
        ...
        '3dpw': join(DATASET_NPZ_PATH, '3dpw_all_test_with_mmpose.npz'),
...
#hparams.DATASET.OCC_AUG_DATASET = 'coco'

...
def main(hparams):
    ...
    hparams.DATASET.NUM_WORKERS = 4  # set this to be compatible with other machines wmh_change这里似乎会覆盖掉pare_config中的参数，batch_size和num_worker都不能太大，现在是32和4，太大服务器会跑崩
